...
import com.github.common.log.event.RequestLogEvent;
...
import com.github.common.log.util.ClassUtil;
...
public class RequestLogAspect {
	...
	public Object around(ProceedingJoinPoint point) {
		...
		try {
			...
			afterReqArgs.forEach(sb::append);

			System.out.println(sb);
			// 发送日志
			SpringContextHolder.publishEvent(new RequestLogEvent(sb.toString()));
		}
