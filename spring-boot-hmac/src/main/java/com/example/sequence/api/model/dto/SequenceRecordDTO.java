package com.example.sequence.api.model.dto;
...
@ApiModel(value = "SequenceRecordDTO", description = "流水号表DTO对象")
public class SequenceRecordDTO implements Serializable {
