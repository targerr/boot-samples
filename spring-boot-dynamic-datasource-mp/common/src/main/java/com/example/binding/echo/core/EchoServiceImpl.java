...
import com.example.binding.StrPool;
import com.example.binding.echo.manager.CacheLoadKeys;
import com.example.binding.echo.manager.ClassManager;
import com.example.binding.echo.manager.FieldParam;
import com.example.binding.echo.manager.LoadKey;
...
//                echoValue = JsonUtils.getJson().toJavaObject(echoValue, echoField.beanClass());
                echoValue = JSON.parseObject(JSON.toJSONString(echoValue), echoField.beanClass());
            }
