package com.example.binding.echo;

import cn.hutool.extra.spring.SpringUtil;
import com.example.binding.echo.core.EchoServiceImpl;
...
public class EchoDataInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        EchoServiceImpl echoServiceImpl = SpringUtil.getBean(EchoServiceImpl.class);
