package ${customizeConfig.dtoConfig.packageName};
...
<#list table.fields as field>
    <#if field.propertyName !="isDelete" && field.propertyName !="createName" && field.propertyName !="createDateTime" && field.propertyName != "modifyName" && field.propertyName !="modifyDateTime" && field.propertyName !="tenantId" && field.propertyName !="areaCode">
    <#if field.keyFlag>
