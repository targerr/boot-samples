...
public class RSASignUtil {
    ...
    public static Map<String, String> generateKeyBytes() {
        try {
            ...
            keyMap.put("publicKey", java.util.Base64.getEncoder().encodeToString(publicKey.getEncoded()));
            keyMap.put("privateKey", java.util.Base64.getEncoder().encodeToString(privateKey.getEncoded()));
            return keyMap;
    ...
    public static String sign(String privateKey, String plain_text) {
        return  cn.hutool.core.codec.Base64.encode((sign(restorePrivateKey(privateKey), plain_text)));
    }
